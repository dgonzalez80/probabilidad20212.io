...
[Presentación 4](https://github.com/dgonzalez80/pye2021.io/blob/main/talleres/P_intro_inferencia_D.pdf)
...
p <- ggdistribution(dchisq, seq(0, 30, 0.1), df = 7, colour = 'blue')
p <- ggdistribution(dchisq, seq(0, 30, 0.1), df = 9, colour = 'green', p = p)
     ggdistribution(dchisq, seq(0, 30, 0.1), df = 11, colour = 'red', p = p)
```
