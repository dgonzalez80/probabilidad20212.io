...
+ $p$ : la proporción y p(1-p) la varianza.  Para conocerla se puede hacer uso de una estimación a traves de una prueba piloto, la varianza máxima que ocurre cuando $p=0.5$  ($pq=0.25$)
