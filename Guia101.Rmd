...
Es importente indicar que variables como: número de la encuesta, número de identificación, telefono, dirección, entre otros, no constituyen variables estadística, auque pueden ser utilzadas para la identificación de la persona u objeto  de donde proviene la información. 
...
A continuación se dará un breve introducción al programa R y RStudio (complementadas con Introducción a R en el Menú : < Código R >)
<br/>
...
El entorno de R consiste en una terminal donde se digitan los códigos de R requidiros para realizar los distintos proceso
...
Tambien existe otro entorno con más elemento que permite una mejor interacción con el lenguaje
...
Este entorno está conformado por ventanas con diferentes funciones:


|   |    ventana    |  función                                      |
|:--|:--------------|:----------------------------------------------|
|1. | Rscrip        | escritura de código R para guardarlo          |
|2  | Consola       | escritura de código                           |
|   | Terminal      |                                               |
|   | R Mardown     | visualización de proceso RMarkdown            |
|   | Jobs          |                                               | 
|3  | Environment   | visualización de variables en memoria         |
|   | History       | visualización de códigos anteriores           |
|   | Connections   |                                               |
|   | Build         |ejecutar código Rmd                            |
|   | Git           |realizar proceso de subida código a GitHub     |
|   | Tutorial      |visualización de tutoriales                    |
|4  | Files         |visualización de archivos y directorio local   |
|5  | Plot          |visualización de gráficos                      |
|6  | Packages      |cargar paquetes                                |
|7  | Help          |ayudas de sintaxis con ejemplos                |
|   | Viewer        |visualización de resultados como paginas html  |
|   |               |                                               |
...
Los datos se pueden importar de diferentes fornas :
