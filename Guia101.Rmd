...
```{r }
DT::datatable(head(iris, 150),fillContainer = FALSE, options = list(pageLength = 10))
```
...
```{r }
var1=c(4,5,6)
DT::datatable(head(bd0052[var1],53),fillContainer = FALSE, options = list(pageLength = 10))
```
