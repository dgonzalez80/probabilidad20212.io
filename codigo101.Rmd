...
1. Utilizando RStudio : 

+ *File /Import Dataset/From text (base)*. En el caso de que los datos en forato csv

+ *File/ Import Dataset/ From Excel*. En caso de estar en fomato xlsx. Aparece una ventana de dialogo para dar los parametros
