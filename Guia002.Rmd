...
4. Suponga que cierta enfermedad está presente en 10 por ciento de la población y que hay una prueba diseñada para detectarla. La prueba no siempre funciona de modo perfecto. Algunas veces la prueba es negativa cuando la enfermedad está presente, y otras positivas cuando no hay la enfermedad. En la siguiente tabla se muestra los resultados obtenidos en un estudio realizado:
