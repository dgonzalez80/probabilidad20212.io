...
library(readxl)
bd0052=read_excel("data/bd0052.xlsx", sheet = "base20211",col_types = c("numeric", "numeric", "text", "text", "numeric", "numeric", "text", "numeric"))
...
boxplot(bd0052$promacum, las=1, horizontal = TRUE, col = c1)
```
...
este indicador de tendencia central se utiliza para promediar tasa de crecimiento o de interes. Para encontar su valor se multiplican los valores de $n$ tasas incrementadas en uno. A ese producto se le extrae la raiz n-esima.
...
bd0052=read_excel("data/bd0052.xlsx", sheet = "base20211",col_types = c("numeric", "numeric", "text", "text", "numeric", "numeric", "text", "numeric")); bd0052$carrera[bd0052$carrera=="Biologia"]="Biología"
