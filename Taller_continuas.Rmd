...
p=ggdistribution(dlnorm, seq(0, 10, 0.1),meanlog=0.8,sdlog=1.2 ,colour= 'blue', fill = "blue", p=p)+
   ggtitle("Distribucion Lognormal (0.8,1.2)")
p
...
p=ggdistribution(dlnorm, seq(5, 20, 0.1),meanlog=0.8,sdlog=1.2 ,colour= 'blue', fill = "blue", p=p)+
   ggtitle("Distribucion Lognormal (10,16)")
p
...
```{r}
p=ggdistribution(dweibull, seq(0, 30, 0.01),shape=b,scale=(1/a)^(1/b) ,colour = 'blue')
p=ggdistribution(dweibull, seq(9, 30, 0.01),shape=b,scale=(1/a)^(1/b) ,colour = 'blue',fill = "blue", p=p)+  
   ggtitle("Distribucion Weibull [a=0.01 b=2]    P(X>9)")
p
pweibull(9,b,(1/a)^(1/b), lower.tail = FALSE)
```
...
```{r}
p=ggdistribution(dweibull, seq(0, 30, 0.01),shape=b,scale=(1/a)^(1/b) ,colour = 'blue')
p=ggdistribution(dweibull, seq(8, 11, 0.01),shape=b,scale=(1/a)^(1/b) ,colour = 'blue',fill = "blue", p=p)+  
   ggtitle("Distribucion Weibull [a=0.01 b=2]    P(8<X<11)")
p
pweibull(11,shape=b,scale=(1/a)^(1/b))-pweibull(8,shape=b,scale=(1/a)^(1/b))
```
...
```{r}
qweibull(0.1,shape=b,scale=(1/a)^(1/b))
```
