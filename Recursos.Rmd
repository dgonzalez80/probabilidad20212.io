...
La segunda columna  de la tabla 1 recoge el número de ocurrencias de cada resultado del experimento planteado ($n_i$), 
lo cual indica el número de lanzamientos de los 1200 ($N$) en que salieron el 1,2,3,4,5 y 6.  
